"""
Django settings for django-recofood project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'django-app-recofood-tfm.onrender.com']
...
ROOT_URLCONF = 'django-recofood.urls'
...
WSGI_APPLICATION = 'django-recofood.wsgi.application'
